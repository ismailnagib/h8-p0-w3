...
STORE "kecepatanPerahu" with value = 30
IF "tinggiOmbak" = 1 THEN
    "kecepatanPerahu" MINUS 7
ELSE IF "tinggiOmbak" = 2 THEN
    "kecepatanPerahu" MINUS 15
ELSE IF "tinggiOmbak" > 2 THEN
    "kecepatanPerahu" BECOME 0
ELSE THEN
    "kecepatanPerahu" DOES NOT CHANGE
